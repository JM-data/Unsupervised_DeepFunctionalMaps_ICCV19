...
![alt-text](https://github.com/JM-data/Unsupervised_FMnet/blob/master/Images/original_faust_example-1.png  "Original FAUST" | width = "600")
...
![alt-text](https://github.com/JM-data/Unsupervised_FMnet/blob/master/Images/remesh_faust_example-1.png "Remeshed FAUST"| width = "600")


We visualize below matches obtained with FMnet on two shapes of different subjects and in different poses: 

![alt-text](https://github.com/JM-data/Unsupervised_FMnet/blob/master/Images/FMnet.png "FMnet" | width = "400")


and our Unsupervised Learning approach yields better results:

![alt-text](https://github.com/JM-data/Unsupervised_FMnet/blob/master/Images/OursAll.png "Our Unsupervised Learning" | width = "400")
